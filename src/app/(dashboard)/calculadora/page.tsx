...
export default function CalculadoraPage() {
  ...
  // Calculadora dutching (múltiplas seleções)
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="simples">
        <TabsList className="bg-gray-900 border border-gray-800 flex flex-wrap h-auto gap-1">
          <TabsTrigger value="simples">💰 Simples</TabsTrigger>
          <TabsTrigger value="dutching">⚖️ Dutching</TabsTrigger>
          <TabsTrigger value="ve">📊 Valor Esperado</TabsTrigger>
        ...
        {/* DUTCHING */}
        <TabsContent value="dutching" className="mt-4">
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                onClick={() =>
                  setSelecoes([...selecoes, { odd: "", stake: "" }])
                }
                variant="outline"
                size="sm"
              ...
              {bancaDutch && (
                <div className="bg-gray-800 rounded-lg p-4">
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    Lucro: R${" "}
                    {(
                      parseFloat(retornoDutch) - parseFloat(bancaDutch)
                    ).toFixed(2)}
                  </p>
                </div>
              )}
        ...
        {/* LAY */}
        <TabsContent value="lay" className="mt-4">
          <Card className="bg-gray-900 border-gray-800">
            <CardHeader>
              <CardTitle className="text-white">
                🔄 Calculadora Lay (Betfair)
